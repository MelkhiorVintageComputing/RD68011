...
module rd68011_decode_rom (
  ...
  always_comb begin
    ...
    casez (op)
      ...
      16'b0100000011000???: entry = 13'd5087;  // MOVE SR,dn
      16'b0100000011010???: entry = 13'd5091;  // MOVE SR,aind
      16'b0100000011011???: entry = 13'd5097;  // MOVE SR,apost
      16'b0100000011100???: entry = 13'd5103;  // MOVE SR,apre
      16'b0100000011101???: entry = 13'd5109;  // MOVE SR,adisp
      16'b0100000011110???: entry = 13'd5116;  // MOVE SR,aidx
      16'b0100000011111000: entry = 13'd5126;  // MOVE SR,absw
      16'b0100000011111001: entry = 13'd5134;  // MOVE SR,absl
      16'b0100001011000???: entry = 13'd5143;  // MOVE CCR,dn
      16'b0100001011010???: entry = 13'd5144;  // MOVE CCR,aind
      16'b0100001011011???: entry = 13'd5147;  // MOVE CCR,apost
      16'b0100001011100???: entry = 13'd5150;  // MOVE CCR,apre
      16'b0100001011101???: entry = 13'd5153;  // MOVE CCR,adisp
      16'b0100001011110???: entry = 13'd5157;  // MOVE CCR,aidx
      16'b0100001011111000: entry = 13'd5163;  // MOVE CCR,absw
      16'b0100001011111001: entry = 13'd5167;  // MOVE CCR,absl
      16'b0100010011000???: entry = 13'd5172;  // MOVE dn,CCR
      16'b0100010011010???: entry = 13'd5176;  // MOVE aind,CCR
      16'b0100010011011???: entry = 13'd5180;  // MOVE apost,CCR
      16'b0100010011100???: entry = 13'd5184;  // MOVE apre,CCR
      16'b0100010011101???: entry = 13'd5188;  // MOVE adisp,CCR
      16'b0100010011110???: entry = 13'd5193;  // MOVE aidx,CCR
      16'b0100010011111000: entry = 13'd5200;  // MOVE absw,CCR
      16'b0100010011111001: entry = 13'd5205;  // MOVE absl,CCR
      16'b0100010011111010: entry = 13'd5211;  // MOVE pcdisp,CCR
      16'b0100010011111011: entry = 13'd5216;  // MOVE pcidx,CCR
      16'b0100010011111100: entry = 13'd5223;  // MOVE imm,CCR
      16'b0100011011000???: entry = 13'd5227;  // MOVE dn,SR
      16'b0100011011010???: entry = 13'd5234;  // MOVE aind,SR
      16'b0100011011011???: entry = 13'd5242;  // MOVE apost,SR
      16'b0100011011100???: entry = 13'd5250;  // MOVE apre,SR
      16'b0100011011101???: entry = 13'd5258;  // MOVE adisp,SR
      16'b0100011011110???: entry = 13'd5267;  // MOVE aidx,SR
      16'b0100011011111000: entry = 13'd5277;  // MOVE absw,SR
      16'b0100011011111001: entry = 13'd5285;  // MOVE absl,SR
      16'b0100011011111010: entry = 13'd5294;  // MOVE pcdisp,SR
      16'b0100011011111011: entry = 13'd5303;  // MOVE pcidx,SR
      16'b0100011011111100: entry = 13'd5313;  // MOVE imm,SR
      16'b0000000000111100: entry = 13'd5320;  // ORI to CCR
      16'b0000000001111100: entry = 13'd5323;  // ORI to SR
      16'b0000001000111100: entry = 13'd5329;  // ANDI to CCR
      16'b0000001001111100: entry = 13'd5332;  // ANDI to SR
      16'b0000101000111100: entry = 13'd5339;  // EORI to CCR
      16'b0000101001111100: entry = 13'd5342;  // EORI to SR
      16'b0100111001100???: entry = 13'd5349;  // MOVE An,USP
      16'b0100111001101???: entry = 13'd5353;  // MOVE USP,An
      16'b0100111001110000: entry = 13'd5357;  // RESET
      16'b0100111001110010: entry = 13'd5367;  // STOP
      16'b0100???110000???: entry = 13'd5372;  // CHK dn
      16'b0100???110010???: entry = 13'd5381;  // CHK aind
      16'b0100???110011???: entry = 13'd5391;  // CHK apost
      16'b0100???110100???: entry = 13'd5401;  // CHK apre
      16'b0100???110101???: entry = 13'd5411;  // CHK adisp
      16'b0100???110110???: entry = 13'd5421;  // CHK aidx
      16'b0100???110111000: entry = 13'd5433;  // CHK absw
      16'b0100???110111001: entry = 13'd5443;  // CHK absl
      16'b0100???110111010: entry = 13'd5455;  // CHK pcdisp
      16'b0100???110111011: entry = 13'd5465;  // CHK pcidx
      16'b0100???110111100: entry = 13'd5477;  // CHK imm
      16'b1100???101000???: entry = 13'd5500;  // EXG dd
      16'b1100???101001???: entry = 13'd5503;  // EXG aa
      16'b1100???110001???: entry = 13'd5506;  // EXG da
      16'b1101???100000???: entry = 13'd5509;  // ADDX.B Dy,Dx
      16'b1101???100001???: entry = 13'd5510;  // ADDX.B -(Ay),-(Ax)
      16'b1101???101000???: entry = 13'd5514;  // ADDX.W Dy,Dx
      16'b1101???101001???: entry = 13'd5515;  // ADDX.W -(Ay),-(Ax)
      16'b1101???110000???: entry = 13'd5519;  // ADDX.L Dy,Dx
      16'b1101???110001???: entry = 13'd5520;  // ADDX.L -(Ay),-(Ax)
      16'b1001???100000???: entry = 13'd5527;  // SUBX.B Dy,Dx
      16'b1001???100001???: entry = 13'd5528;  // SUBX.B -(Ay),-(Ax)
      16'b1001???101000???: entry = 13'd5532;  // SUBX.W Dy,Dx
      16'b1001???101001???: entry = 13'd5533;  // SUBX.W -(Ay),-(Ax)
      16'b1001???110000???: entry = 13'd5537;  // SUBX.L Dy,Dx
      16'b1001???110001???: entry = 13'd5538;  // SUBX.L -(Ay),-(Ax)
      16'b1011???100001???: entry = 13'd5545;  // CMPM.B
      16'b1011???101001???: entry = 13'd5548;  // CMPM.W
      16'b1011???110001???: entry = 13'd5551;  // CMPM.L
      16'b1100???100000???: entry = 13'd5556;  // ABCD Dy,Dx
      16'b1100???100001???: entry = 13'd5557;  // ABCD -(Ay),-(Ax)
      16'b1000???100000???: entry = 13'd5561;  // SBCD Dy,Dx
      16'b1000???100001???: entry = 13'd5562;  // SBCD -(Ay),-(Ax)
      16'b0100100000000???: entry = 13'd5566;  // NBCD dn
      16'b0100100000010???: entry = 13'd5567;  // NBCD aind
      16'b0100100000011???: entry = 13'd5570;  // NBCD apost
      16'b0100100000100???: entry = 13'd5573;  // NBCD apre
      16'b0100100000101???: entry = 13'd5576;  // NBCD adisp
      16'b0100100000110???: entry = 13'd5580;  // NBCD aidx
      16'b0100100000111000: entry = 13'd5586;  // NBCD absw
      16'b0100100000111001: entry = 13'd5590;  // NBCD absl
      16'b1100???011000???: entry = 13'd5595;  // MULU dn
      16'b1100???011010???: entry = 13'd5596;  // MULU aind
      16'b1100???011011???: entry = 13'd5598;  // MULU apost
      16'b1100???011100???: entry = 13'd5600;  // MULU apre
      16'b1100???011101???: entry = 13'd5602;  // MULU adisp
      16'b1100???011110???: entry = 13'd5605;  // MULU aidx
      16'b1100???011111000: entry = 13'd5610;  // MULU absw
      16'b1100???011111001: entry = 13'd5613;  // MULU absl
      16'b1100???011111010: entry = 13'd5617;  // MULU pcdisp
      16'b1100???011111011: entry = 13'd5620;  // MULU pcidx
      16'b1100???011111100: entry = 13'd5625;  // MULU imm
      16'b1100???111000???: entry = 13'd5627;  // MULS dn
      16'b1100???111010???: entry = 13'd5628;  // MULS aind
      16'b1100???111011???: entry = 13'd5630;  // MULS apost
      16'b1100???111100???: entry = 13'd5632;  // MULS apre
      16'b1100???111101???: entry = 13'd5634;  // MULS adisp
      16'b1100???111110???: entry = 13'd5637;  // MULS aidx
      16'b1100???111111000: entry = 13'd5642;  // MULS absw
      16'b1100???111111001: entry = 13'd5645;  // MULS absl
      16'b1100???111111010: entry = 13'd5649;  // MULS pcdisp
      16'b1100???111111011: entry = 13'd5652;  // MULS pcidx
      16'b1100???111111100: entry = 13'd5657;  // MULS imm
      16'b1000???011000???: entry = 13'd5659;  // DIVU dn
      16'b1000???011010???: entry = 13'd5676;  // DIVU aind
      16'b1000???011011???: entry = 13'd5692;  // DIVU apost
      16'b1000???011100???: entry = 13'd5708;  // DIVU apre
      16'b1000???011101???: entry = 13'd5724;  // DIVU adisp
      16'b1000???011110???: entry = 13'd5742;  // DIVU aidx
      16'b1000???011111000: entry = 13'd5762;  // DIVU absw
      16'b1000???011111001: entry = 13'd5780;  // DIVU absl
      16'b1000???011111010: entry = 13'd5798;  // DIVU pcdisp
      16'b1000???011111011: entry = 13'd5816;  // DIVU pcidx
      16'b1000???011111100: entry = 13'd5836;  // DIVU imm
      16'b1000???111000???: entry = 13'd5852;  // DIVS dn
      16'b1000???111010???: entry = 13'd5868;  // DIVS aind
      16'b1000???111011???: entry = 13'd5884;  // DIVS apost
      16'b1000???111100???: entry = 13'd5900;  // DIVS apre
      16'b1000???111101???: entry = 13'd5916;  // DIVS adisp
      16'b1000???111110???: entry = 13'd5934;  // DIVS aidx
      16'b1000???111111000: entry = 13'd5954;  // DIVS absw
      16'b1000???111111001: entry = 13'd5972;  // DIVS absl
      16'b1000???111111010: entry = 13'd5990;  // DIVS pcdisp
      16'b1000???111111011: entry = 13'd6008;  // DIVS pcidx
      16'b1000???111111100: entry = 13'd6028;  // DIVS imm
      16'b0000???100001???: entry = 13'd6047;  // MOVEP.W memory to Dx
      16'b0000???110001???: entry = 13'd6051;  // MOVEP.W Dx to memory
      16'b0000???101001???: entry = 13'd6055;  // MOVEP.L memory to Dx
      16'b0000???111001???: entry = 13'd6061;  // MOVEP.L Dx to memory
      16'b0100100010010???: entry = 13'd6067;  // MOVEM.W from aind
      16'b0100100010100???: entry = 13'd6070;  // MOVEM.W from apre
      16'b0100100010101???: entry = 13'd6074;  // MOVEM.W from adisp
      16'b0100100010110???: entry = 13'd6078;  // MOVEM.W from aidx
      16'b0100100010111000: entry = 13'd6084;  // MOVEM.W from absw
      16'b0100100010111001: entry = 13'd6088;  // MOVEM.W from absl
      16'b0100110010010???: entry = 13'd6094;  // MOVEM.W to aind
      16'b0100110010011???: entry = 13'd6099;  // MOVEM.W to apost
      16'b0100110010101???: entry = 13'd6103;  // MOVEM.W to adisp
      16'b0100110010110???: entry = 13'd6109;  // MOVEM.W to aidx
      16'b0100110010111000: entry = 13'd6117;  // MOVEM.W to absw
      16'b0100110010111001: entry = 13'd6123;  // MOVEM.W to absl
      16'b0100110010111010: entry = 13'd6129;  // MOVEM.W to pcdisp
      16'b0100110010111011: entry = 13'd6135;  // MOVEM.W to pcidx
      16'b0100100011010???: entry = 13'd6143;  // MOVEM.L from aind
      16'b0100100011100???: entry = 13'd6147;  // MOVEM.L from apre
      16'b0100100011101???: entry = 13'd6151;  // MOVEM.L from adisp
      16'b0100100011110???: entry = 13'd6157;  // MOVEM.L from aidx
      16'b0100100011111000: entry = 13'd6165;  // MOVEM.L from absw
      16'b0100100011111001: entry = 13'd6171;  // MOVEM.L from absl
      16'b0100110011010???: entry = 13'd6177;  // MOVEM.L to aind
      16'b0100110011011???: entry = 13'd6182;  // MOVEM.L to apost
      16'b0100110011101???: entry = 13'd6188;  // MOVEM.L to adisp
      16'b0100110011110???: entry = 13'd6194;  // MOVEM.L to aidx
      16'b0100110011111000: entry = 13'd6202;  // MOVEM.L to absw
      16'b0100110011111001: entry = 13'd6208;  // MOVEM.L to absl
      16'b0100110011111010: entry = 13'd6216;  // MOVEM.L to pcdisp
      16'b0100110011111011: entry = 13'd6222;  // MOVEM.L to pcidx
      16'b0100111001110100: entry = 13'd6230;  // RTD
      16'b0100100001001???: entry = 13'd6236;  // BKPT
      16'b0100111001111010: entry = 13'd6239;  // MOVEC Rc,Rn
      16'b0100111001111011: entry = 13'd6248;  // MOVEC Rn,Rc
      16'b0000111000010???: entry = 13'd6258;  // MOVES.B aind
      16'b0000111000011???: entry = 13'd6270;  // MOVES.B apost
      16'b0000111000100???: entry = 13'd6282;  // MOVES.B apre
      16'b0000111000101???: entry = 13'd6294;  // MOVES.B adisp
      16'b0000111000110???: entry = 13'd6308;  // MOVES.B aidx
      16'b0000111000111000: entry = 13'd6326;  // MOVES.B absw
      16'b0000111000111001: entry = 13'd6340;  // MOVES.B absl
      16'b0000111001010???: entry = 13'd6356;  // MOVES.W aind
      16'b0000111001011???: entry = 13'd6368;  // MOVES.W apost
      16'b0000111001100???: entry = 13'd6380;  // MOVES.W apre
      16'b0000111001101???: entry = 13'd6392;  // MOVES.W adisp
      16'b0000111001110???: entry = 13'd6406;  // MOVES.W aidx
      16'b0000111001111000: entry = 13'd6424;  // MOVES.W absw
      16'b0000111001111001: entry = 13'd6438;  // MOVES.W absl
      16'b0000111010010???: entry = 13'd6454;  // MOVES.L aind
      16'b0000111010011???: entry = 13'd6468;  // MOVES.L apost
      16'b0000111010100???: entry = 13'd6482;  // MOVES.L apre
      16'b0000111010101???: entry = 13'd6496;  // MOVES.L adisp
      16'b0000111010110???: entry = 13'd6512;  // MOVES.L aidx
      16'b0000111010111000: entry = 13'd6532;  // MOVES.L absw
      16'b0000111010111001: entry = 13'd6548;  // MOVES.L absl
      default: begin
        entry   = 13'd9;  // illegal
        illegal = 1'b1;
      end
