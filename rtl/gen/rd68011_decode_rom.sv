...
module rd68011_decode_rom (
  ...
  always_comb begin
    ...
    casez (op)
      ...
      16'b0110????00000000: entry = 13'd4890;  // Bcc.W
      16'b0110????????????: entry = 13'd4882;  // Bcc.B
      16'b0100111011010???: entry = 13'd4899;  // JMP aind
      16'b0100111011101???: entry = 13'd4902;  // JMP adisp
      16'b0100111011110???: entry = 13'd4906;  // JMP aidx
      16'b0100111011111000: entry = 13'd4911;  // JMP absw
      16'b0100111011111001: entry = 13'd4915;  // JMP absl
      16'b0100111011111010: entry = 13'd4919;  // JMP pcdisp
      16'b0100111011111011: entry = 13'd4923;  // JMP pcidx
      16'b0100111010010???: entry = 13'd4928;  // JSR aind
      16'b0100111010101???: entry = 13'd4934;  // JSR adisp
      16'b0100111010110???: entry = 13'd4941;  // JSR aidx
      16'b0100111010111000: entry = 13'd4949;  // JSR absw
      16'b0100111010111001: entry = 13'd4956;  // JSR absl
      16'b0100111010111010: entry = 13'd4963;  // JSR pcdisp
      16'b0100111010111011: entry = 13'd4970;  // JSR pcidx
      16'b0100111001110101: entry = 13'd4978;  // RTS
      16'b0100111001110111: entry = 13'd4983;  // RTR
      16'b0100111001010???: entry = 13'd4989;  // LINK
      16'b0100111001011???: entry = 13'd4993;  // UNLK
      16'b0100101011111100: entry = 13'd5008;  // ILLEGAL
      16'b1010????????????: entry = 13'd5011;  // line A
      16'b1111????????????: entry = 13'd5014;  // line F
      16'b010011100100????: entry = 13'd5017;  // TRAP
      16'b0100111001110110: entry = 13'd5020;  // TRAPV
      16'b0100111001110011: entry = 13'd5031;  // RTE
      16'b0100000011000???: entry = 13'd5048;  // MOVE SR,dn
      16'b0100000011010???: entry = 13'd5053;  // MOVE SR,aind
      16'b0100000011011???: entry = 13'd5059;  // MOVE SR,apost
      16'b0100000011100???: entry = 13'd5065;  // MOVE SR,apre
      16'b0100000011101???: entry = 13'd5071;  // MOVE SR,adisp
      16'b0100000011110???: entry = 13'd5078;  // MOVE SR,aidx
      16'b0100000011111000: entry = 13'd5088;  // MOVE SR,absw
      16'b0100000011111001: entry = 13'd5096;  // MOVE SR,absl
      16'b0100001011000???: entry = 13'd5105;  // MOVE CCR,dn
      16'b0100001011010???: entry = 13'd5106;  // MOVE CCR,aind
      16'b0100001011011???: entry = 13'd5109;  // MOVE CCR,apost
      16'b0100001011100???: entry = 13'd5112;  // MOVE CCR,apre
      16'b0100001011101???: entry = 13'd5115;  // MOVE CCR,adisp
      16'b0100001011110???: entry = 13'd5119;  // MOVE CCR,aidx
      16'b0100001011111000: entry = 13'd5125;  // MOVE CCR,absw
      16'b0100001011111001: entry = 13'd5129;  // MOVE CCR,absl
      16'b0100010011000???: entry = 13'd5134;  // MOVE dn,CCR
      16'b0100010011010???: entry = 13'd5138;  // MOVE aind,CCR
      16'b0100010011011???: entry = 13'd5142;  // MOVE apost,CCR
      16'b0100010011100???: entry = 13'd5146;  // MOVE apre,CCR
      16'b0100010011101???: entry = 13'd5150;  // MOVE adisp,CCR
      16'b0100010011110???: entry = 13'd5155;  // MOVE aidx,CCR
      16'b0100010011111000: entry = 13'd5162;  // MOVE absw,CCR
      16'b0100010011111001: entry = 13'd5167;  // MOVE absl,CCR
      16'b0100010011111010: entry = 13'd5173;  // MOVE pcdisp,CCR
      16'b0100010011111011: entry = 13'd5178;  // MOVE pcidx,CCR
      16'b0100010011111100: entry = 13'd5185;  // MOVE imm,CCR
      16'b0100011011000???: entry = 13'd5189;  // MOVE dn,SR
      16'b0100011011010???: entry = 13'd5196;  // MOVE aind,SR
      16'b0100011011011???: entry = 13'd5204;  // MOVE apost,SR
      16'b0100011011100???: entry = 13'd5212;  // MOVE apre,SR
      16'b0100011011101???: entry = 13'd5220;  // MOVE adisp,SR
      16'b0100011011110???: entry = 13'd5229;  // MOVE aidx,SR
      16'b0100011011111000: entry = 13'd5239;  // MOVE absw,SR
      16'b0100011011111001: entry = 13'd5247;  // MOVE absl,SR
      16'b0100011011111010: entry = 13'd5256;  // MOVE pcdisp,SR
      16'b0100011011111011: entry = 13'd5265;  // MOVE pcidx,SR
      16'b0100011011111100: entry = 13'd5275;  // MOVE imm,SR
      16'b0000000000111100: entry = 13'd5282;  // ORI to CCR
      16'b0000000001111100: entry = 13'd5285;  // ORI to SR
      16'b0000001000111100: entry = 13'd5291;  // ANDI to CCR
      16'b0000001001111100: entry = 13'd5294;  // ANDI to SR
      16'b0000101000111100: entry = 13'd5301;  // EORI to CCR
      16'b0000101001111100: entry = 13'd5304;  // EORI to SR
      16'b0100111001100???: entry = 13'd5311;  // MOVE An,USP
      16'b0100111001101???: entry = 13'd5315;  // MOVE USP,An
      16'b0100111001110000: entry = 13'd5319;  // RESET
      16'b0100111001110010: entry = 13'd5329;  // STOP
      16'b0100???110000???: entry = 13'd5334;  // CHK dn
      16'b0100???110010???: entry = 13'd5343;  // CHK aind
      16'b0100???110011???: entry = 13'd5353;  // CHK apost
      16'b0100???110100???: entry = 13'd5363;  // CHK apre
      16'b0100???110101???: entry = 13'd5373;  // CHK adisp
      16'b0100???110110???: entry = 13'd5383;  // CHK aidx
      16'b0100???110111000: entry = 13'd5395;  // CHK absw
      16'b0100???110111001: entry = 13'd5405;  // CHK absl
      16'b0100???110111010: entry = 13'd5417;  // CHK pcdisp
      16'b0100???110111011: entry = 13'd5427;  // CHK pcidx
      16'b0100???110111100: entry = 13'd5439;  // CHK imm
      16'b1100???101000???: entry = 13'd5462;  // EXG dd
      16'b1100???101001???: entry = 13'd5465;  // EXG aa
      16'b1100???110001???: entry = 13'd5468;  // EXG da
      16'b1101???100000???: entry = 13'd5471;  // ADDX.B Dy,Dx
      16'b1101???100001???: entry = 13'd5472;  // ADDX.B -(Ay),-(Ax)
      16'b1101???101000???: entry = 13'd5476;  // ADDX.W Dy,Dx
      16'b1101???101001???: entry = 13'd5477;  // ADDX.W -(Ay),-(Ax)
      16'b1101???110000???: entry = 13'd5481;  // ADDX.L Dy,Dx
      16'b1101???110001???: entry = 13'd5482;  // ADDX.L -(Ay),-(Ax)
      16'b1001???100000???: entry = 13'd5489;  // SUBX.B Dy,Dx
      16'b1001???100001???: entry = 13'd5490;  // SUBX.B -(Ay),-(Ax)
      16'b1001???101000???: entry = 13'd5494;  // SUBX.W Dy,Dx
      16'b1001???101001???: entry = 13'd5495;  // SUBX.W -(Ay),-(Ax)
      16'b1001???110000???: entry = 13'd5499;  // SUBX.L Dy,Dx
      16'b1001???110001???: entry = 13'd5500;  // SUBX.L -(Ay),-(Ax)
      16'b1011???100001???: entry = 13'd5507;  // CMPM.B
      16'b1011???101001???: entry = 13'd5510;  // CMPM.W
      16'b1011???110001???: entry = 13'd5513;  // CMPM.L
      16'b1100???100000???: entry = 13'd5518;  // ABCD Dy,Dx
      16'b1100???100001???: entry = 13'd5519;  // ABCD -(Ay),-(Ax)
      16'b1000???100000???: entry = 13'd5523;  // SBCD Dy,Dx
      16'b1000???100001???: entry = 13'd5524;  // SBCD -(Ay),-(Ax)
      16'b0100100000000???: entry = 13'd5528;  // NBCD dn
      16'b0100100000010???: entry = 13'd5529;  // NBCD aind
      16'b0100100000011???: entry = 13'd5532;  // NBCD apost
      16'b0100100000100???: entry = 13'd5535;  // NBCD apre
      16'b0100100000101???: entry = 13'd5538;  // NBCD adisp
      16'b0100100000110???: entry = 13'd5542;  // NBCD aidx
      16'b0100100000111000: entry = 13'd5548;  // NBCD absw
      16'b0100100000111001: entry = 13'd5552;  // NBCD absl
      16'b1100???011000???: entry = 13'd5557;  // MULU dn
      16'b1100???011010???: entry = 13'd5558;  // MULU aind
      16'b1100???011011???: entry = 13'd5560;  // MULU apost
      16'b1100???011100???: entry = 13'd5562;  // MULU apre
      16'b1100???011101???: entry = 13'd5564;  // MULU adisp
      16'b1100???011110???: entry = 13'd5567;  // MULU aidx
      16'b1100???011111000: entry = 13'd5572;  // MULU absw
      16'b1100???011111001: entry = 13'd5575;  // MULU absl
      16'b1100???011111010: entry = 13'd5579;  // MULU pcdisp
      16'b1100???011111011: entry = 13'd5582;  // MULU pcidx
      16'b1100???011111100: entry = 13'd5587;  // MULU imm
      16'b1100???111000???: entry = 13'd5589;  // MULS dn
      16'b1100???111010???: entry = 13'd5590;  // MULS aind
      16'b1100???111011???: entry = 13'd5592;  // MULS apost
      16'b1100???111100???: entry = 13'd5594;  // MULS apre
      16'b1100???111101???: entry = 13'd5596;  // MULS adisp
      16'b1100???111110???: entry = 13'd5599;  // MULS aidx
      16'b1100???111111000: entry = 13'd5604;  // MULS absw
      16'b1100???111111001: entry = 13'd5607;  // MULS absl
      16'b1100???111111010: entry = 13'd5611;  // MULS pcdisp
      16'b1100???111111011: entry = 13'd5614;  // MULS pcidx
      16'b1100???111111100: entry = 13'd5619;  // MULS imm
      16'b1000???011000???: entry = 13'd5621;  // DIVU dn
      16'b1000???011010???: entry = 13'd5638;  // DIVU aind
      16'b1000???011011???: entry = 13'd5654;  // DIVU apost
      16'b1000???011100???: entry = 13'd5670;  // DIVU apre
      16'b1000???011101???: entry = 13'd5686;  // DIVU adisp
      16'b1000???011110???: entry = 13'd5704;  // DIVU aidx
      16'b1000???011111000: entry = 13'd5724;  // DIVU absw
      16'b1000???011111001: entry = 13'd5742;  // DIVU absl
      16'b1000???011111010: entry = 13'd5760;  // DIVU pcdisp
      16'b1000???011111011: entry = 13'd5778;  // DIVU pcidx
      16'b1000???011111100: entry = 13'd5798;  // DIVU imm
      16'b1000???111000???: entry = 13'd5814;  // DIVS dn
      16'b1000???111010???: entry = 13'd5830;  // DIVS aind
      16'b1000???111011???: entry = 13'd5846;  // DIVS apost
      16'b1000???111100???: entry = 13'd5862;  // DIVS apre
      16'b1000???111101???: entry = 13'd5878;  // DIVS adisp
      16'b1000???111110???: entry = 13'd5896;  // DIVS aidx
      16'b1000???111111000: entry = 13'd5916;  // DIVS absw
      16'b1000???111111001: entry = 13'd5934;  // DIVS absl
      16'b1000???111111010: entry = 13'd5952;  // DIVS pcdisp
      16'b1000???111111011: entry = 13'd5970;  // DIVS pcidx
      16'b1000???111111100: entry = 13'd5990;  // DIVS imm
      16'b0000???100001???: entry = 13'd6009;  // MOVEP.W memory to Dx
      16'b0000???110001???: entry = 13'd6013;  // MOVEP.W Dx to memory
      16'b0000???101001???: entry = 13'd6017;  // MOVEP.L memory to Dx
      16'b0000???111001???: entry = 13'd6023;  // MOVEP.L Dx to memory
      16'b0100100010010???: entry = 13'd6029;  // MOVEM.W from aind
      16'b0100100010100???: entry = 13'd6032;  // MOVEM.W from apre
      16'b0100100010101???: entry = 13'd6036;  // MOVEM.W from adisp
      16'b0100100010110???: entry = 13'd6040;  // MOVEM.W from aidx
      16'b0100100010111000: entry = 13'd6046;  // MOVEM.W from absw
      16'b0100100010111001: entry = 13'd6050;  // MOVEM.W from absl
      16'b0100110010010???: entry = 13'd6056;  // MOVEM.W to aind
      16'b0100110010011???: entry = 13'd6061;  // MOVEM.W to apost
      16'b0100110010101???: entry = 13'd6065;  // MOVEM.W to adisp
      16'b0100110010110???: entry = 13'd6071;  // MOVEM.W to aidx
      16'b0100110010111000: entry = 13'd6079;  // MOVEM.W to absw
      16'b0100110010111001: entry = 13'd6085;  // MOVEM.W to absl
      16'b0100110010111010: entry = 13'd6091;  // MOVEM.W to pcdisp
      16'b0100110010111011: entry = 13'd6097;  // MOVEM.W to pcidx
      16'b0100100011010???: entry = 13'd6105;  // MOVEM.L from aind
      16'b0100100011100???: entry = 13'd6109;  // MOVEM.L from apre
      16'b0100100011101???: entry = 13'd6113;  // MOVEM.L from adisp
      16'b0100100011110???: entry = 13'd6119;  // MOVEM.L from aidx
      16'b0100100011111000: entry = 13'd6127;  // MOVEM.L from absw
      16'b0100100011111001: entry = 13'd6133;  // MOVEM.L from absl
      16'b0100110011010???: entry = 13'd6139;  // MOVEM.L to aind
      16'b0100110011011???: entry = 13'd6144;  // MOVEM.L to apost
      16'b0100110011101???: entry = 13'd6150;  // MOVEM.L to adisp
      16'b0100110011110???: entry = 13'd6156;  // MOVEM.L to aidx
      16'b0100110011111000: entry = 13'd6164;  // MOVEM.L to absw
      16'b0100110011111001: entry = 13'd6170;  // MOVEM.L to absl
      16'b0100110011111010: entry = 13'd6178;  // MOVEM.L to pcdisp
      16'b0100110011111011: entry = 13'd6184;  // MOVEM.L to pcidx
      16'b0100111001110100: entry = 13'd6192;  // RTD
      16'b0100100001001???: entry = 13'd6198;  // BKPT
      16'b0100111001111010: entry = 13'd6201;  // MOVEC Rc,Rn
      16'b0100111001111011: entry = 13'd6210;  // MOVEC Rn,Rc
      16'b0000111000010???: entry = 13'd6220;  // MOVES.B aind
      16'b0000111000011???: entry = 13'd6232;  // MOVES.B apost
      16'b0000111000100???: entry = 13'd6244;  // MOVES.B apre
      16'b0000111000101???: entry = 13'd6256;  // MOVES.B adisp
      16'b0000111000110???: entry = 13'd6270;  // MOVES.B aidx
      16'b0000111000111000: entry = 13'd6288;  // MOVES.B absw
      16'b0000111000111001: entry = 13'd6302;  // MOVES.B absl
      16'b0000111001010???: entry = 13'd6318;  // MOVES.W aind
      16'b0000111001011???: entry = 13'd6330;  // MOVES.W apost
      16'b0000111001100???: entry = 13'd6342;  // MOVES.W apre
      16'b0000111001101???: entry = 13'd6354;  // MOVES.W adisp
      16'b0000111001110???: entry = 13'd6368;  // MOVES.W aidx
      16'b0000111001111000: entry = 13'd6386;  // MOVES.W absw
      16'b0000111001111001: entry = 13'd6400;  // MOVES.W absl
      16'b0000111010010???: entry = 13'd6416;  // MOVES.L aind
      16'b0000111010011???: entry = 13'd6430;  // MOVES.L apost
      16'b0000111010100???: entry = 13'd6444;  // MOVES.L apre
      16'b0000111010101???: entry = 13'd6458;  // MOVES.L adisp
      16'b0000111010110???: entry = 13'd6474;  // MOVES.L aidx
      16'b0000111010111000: entry = 13'd6494;  // MOVES.L absw
      16'b0000111010111001: entry = 13'd6510;  // MOVES.L absl
      default: begin
        entry   = 13'd9;  // illegal
        illegal = 1'b1;
      end
